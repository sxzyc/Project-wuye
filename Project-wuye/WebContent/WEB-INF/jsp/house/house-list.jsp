...
<div class="ch-container">
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable" id="tables">
    <thead>
    <a class="btn btn-success" href="house/housePWD">
