	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form"  data-toggle="validator"  action="charge/chargeAdd" method="post" >
				<fieldset>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的数字" name="metre" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-3">
                            ...
                            <input type="text" class="form-control" pattern="^[0-9]+(\.[0-9]{0,2})?$" data-error="请输入有效的价格" name="scost" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group">
