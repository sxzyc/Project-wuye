                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="charge/chargePWD">
                                ...
                                <c:forEach var="charge" items="${charges}" >
									<tr>
										...
										<td>${charge.smemo}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="charge/findById?id=${charge.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="charge/chargeDelete?id=${charge.id}" data-toggle="modal" data-target="#myModal">
