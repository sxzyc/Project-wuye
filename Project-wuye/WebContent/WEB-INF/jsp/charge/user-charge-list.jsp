                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="javascript:location.href='<%=basePath %>charge/chargeUserList?username='+encodeURIComponent('${customAccount.username }');"><i class="glyphicon glyphicon-usd"></i><span> &ensp;收&ensp;费&ensp;管&ensp;理</span></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:location.href='<%=basePath %>charge/chargeUserList?username='+encodeURIComponent('${customAccount.username }');">收费管理</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-usd"></i> 收费管理</h2>
