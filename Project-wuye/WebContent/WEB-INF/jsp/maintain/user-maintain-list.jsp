                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="javascript:location.href='<%=basePath %>maintain/maintainUserList?username='+encodeURIComponent('${customAccount.username }');"><i class="glyphicon glyphicon-wrench"></i><span> &ensp;报&ensp;修&ensp;管&ensp;理</span></a>
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:location.href='<%=basePath %>maintain/maintainUserList?username='+encodeURIComponent('${customAccount.username }');">报修管理</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tables">
                                <thead>
                                <a class="btn btn-success" href="maintain/maintainUserPWD">
                                ...
                                <c:forEach var="maintain" items="${maintains}" >
									<tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-danger" href="#" data-href="javascript:location.href='<%=basePath %>maintain/maintainUserDelete?id=${maintain.id}&maintainer='+encodeURIComponent('${maintain.maintainer}');" data-toggle="modal" data-target="#myModal">
