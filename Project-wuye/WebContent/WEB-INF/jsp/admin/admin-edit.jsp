                ...
                <form action="admin/adminEdit" method="post" data-toggle="validator">
                    <div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="name" value="${adminOne.name}" required/>
					...
					<div class="form-group">
						<div class="input-group col-md-1">
							...
							<input type="number" class="form-control" name="age" value="${adminOne.age}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="tel" value="${adminOne.tel}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							<label class="control-label" for="phone">手机</label>
							<input type="text" class="form-control" name="phone" value="${adminOne.phone}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							<label class="control-label" for="addr">地址*</label>
							<input type="text" class="form-control" name="addr" value="${adminOne.addr}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							...
							<input type="text" class="form-control" name="memo" value="${adminOne.memo}"/>
						</div>
					</div>
