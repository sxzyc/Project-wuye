                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive"  id="tables">
                                <thead>
                                <a class="btn btn-success" href="admin/adminPWD">
                                ...
                                <tbody>
                                <c:forEach var="adminTwo" items="${Aadmins}" >
                                    <tr>
                                        <td>${adminTwo.name}</td>
                                        <td>******</td>
                                        <td>${adminTwo.sex}</td>
                                        <td>${adminTwo.age}</td>
                                        <td>${adminTwo.tel}</td>
                                        <td>${adminTwo.phone}</td>
                                        <td>${adminTwo.addr}</td>
                                        <td>${adminTwo.memo}</td>
                                        <td class="center">
                                            <a class="btn btn-info" href="admin/findById?id=${adminTwo.id}">
                                                <i class="glyphicon glyphicon-edit icon-white"></i>
                                                编&ensp;辑
                                            </a>
                                            <a class="btn btn-danger" href="#" data-href="admin/adminDelete?id=${adminTwo.id}" data-toggle="modal" data-target="#myModal">
